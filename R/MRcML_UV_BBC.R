...
MRcML_UV_BBC=function(by,bx,byse,bxse,gcov,ldsc,cov_RB,max.iter=30,max.eps=1e-5,lambda=3,a=3,sampling.time=300,n_threads=4,max.prop.pleio=0.5,sampling.strategy="subsampling"){
######### Basic Processing  ##############
by=by/byse
byseinv=1/byse
bx=bx*byseinv
