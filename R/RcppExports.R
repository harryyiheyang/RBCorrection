...
RaoBlackwell <- function(beta_select, se_select, RxyList, RxysqrtList, eta, cutoff, B, min_accept = 100L, onlyexposure = TRUE, n_threads = 1L) {
    .Call(`_RBCorrection_RaoBlackwell`, beta_select, se_select, RxyList, RxysqrtList, eta, cutoff, B, min_accept, onlyexposure, n_threads)
}
